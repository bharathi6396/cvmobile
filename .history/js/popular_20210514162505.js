    ...
    $.ajax({
        ...
        success: function (data, status, response) {
            ...
            popularFilms.forEach(element => { 
                ...
                let addh2 = `<h2 ="${URL_POPULAR + element.name}">`;
                let addDate = `<p ="${URL_POPULAR element.release_date}">`;
                $(".sideScroll").append(addBack);
                $(".sideScroll").append(addh2);
                $(".sideScroll").append(addDate);
