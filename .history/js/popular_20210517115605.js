...
const URL_POPULAR_STREAMING ="https://api.themoviedb.org/3/movie/popular/all/streaming?api_key=b8e16ff25f44004fe2ab5dedc9e0453e&language=en-US&page=1e";
const URL_POPULAR_STREAMING ="https://api.themoviedb.org/3/movie/popular/all/TV?api_key=b8e16ff25f44004fe2ab5dedc9e0453e&language=en-US&page=1e";
$(function(){
    console.log();
    $.ajax({
        url:URL_POPULAR,
