    ...
    $.ajax({
        ...
        success: function (data, statuts, response) {
            ...
            trailer.forEach(function (element) {
                console.log(element)
                let lien = `<a href="#" class="movie-item"><iframe src="${YOUTUBE_URL + element.key}"frameborder="1" allowfullscreen></iframe>`;
    ...
    $.ajax({
        ...
        success: function (data, status, response) {
            ...
            filmstrailers.forEach(element => {
                let addBack = `<iframe src="${YOUTUBE_URL + element.key}"frameborder="1" allowfullscreen></iframe>`;
