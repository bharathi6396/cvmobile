...
$.ajax({
        ...
        success: function (data, statuts, response) {
            ...
            moviesTendance.forEach(function (element) {
                let moviesTendanceToAdd = `<a href="film.html?filmId=${element.id}" class="movie-item"><img img src="${URL_IMAGE_PREFIX + element.poster_path}"> <div><div class="change"> ${element.original_title}  </div> <p> ${element.release_date}</p> </div> </a>`;
