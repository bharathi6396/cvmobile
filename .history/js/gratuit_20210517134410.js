const URL_GRATUIT="Thttps://api.themoviedb.org/3/discover/movie?api_key=b8e16ff25f44004fe2ab5dedc9e0453e&language=english&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate";
const URL_GRATUIT_TV="https://api.themoviedb.org/3/discover/movie?api_key=b8e16ff25f44004fe2ab5dedc9e0453e&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=buy";
$(function () {
    $.ajax({
        method: "GET",
        url: URL_GRATUIT,
