    ...
    $.ajax({
        ...
        success: function (data, status, response) {
            ...
            filmstrailers.forEach(element => {
                let addBack = `<a href="film.html?filmId=${element.id}" class="movie-item"> <video src="${URL_IMAGE_PREFIX + element.id}"><div id="flexbox"><div class="change"> ${element.name}  </div> <p> ${element.release_date}</p> </div> </a>`;
